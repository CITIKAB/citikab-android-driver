package com.trioangle.goferdriver.proswipebutton;
...
import static com.trioangle.goferdriver.proswipebutton.Constants.BTN_INIT_RADIUS;
import static com.trioangle.goferdriver.proswipebutton.Constants.BTN_MORPHED_RADIUS;
import static com.trioangle.goferdriver.proswipebutton.Constants.DEFAULT_SWIPE_DISTANCE;
import static com.trioangle.goferdriver.proswipebutton.Constants.DEFAULT_TEXT_SIZE;
import static com.trioangle.goferdriver.proswipebutton.Constants.MORPH_ANIM_DURATION;
import static com.trioangle.goferdriver.proswipebutton.UiUtils.animateFadeHide;
import static com.trioangle.goferdriver.proswipebutton.UiUtils.animateFadeShow;
import static com.trioangle.goferdriver.proswipebutton.UiUtils.dpToPx;
...
public class ProSwipeButton extends RelativeLayout {
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            bgColorInt = a.getColor(R.styleable.ProSwipeButton_bg_color, ContextCompat.getColor(context, R.color.app_confirm_trip));
    ...
    private void rotateArrow() {
        ...
        String layoutDirection = getResources().getString(R.string.layout_direction);
        if(layoutDirection.equals("0")){
            arrow1.setScaleX(1);
            arrow1.setScaleY(1);
            arrow2.setScaleX(1);
            arrow2.setScaleY(1);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        System.out.println("event getx One : " + event.getX()); // ?
                        System.out.println("arrowHintContainer.getWidth() One" + arrowHintContainer.getWidth()); // width of the arrow
                        System.out.println("getWidth() One" + getWidth()); // total button width
                        System.out.println("arrowHintContainer.getX() One" + arrowHintContainer.getX()); // position of the arrow
                    ...
                    case MotionEvent.ACTION_UP:
                        System.out.println("event getx Two : " + event.getX());
                        System.out.println("arrowHintContainer.getWidth() Two" + arrowHintContainer.getWidth()); // width of the arrow
                        System.out.println("getWidth() Two" + getWidth()); // total button width
                        System.out.println("arrowHintContainer.getX() Two" + arrowHintContainer.getX()); // position of the arrow




                        layoutDirection = getResources().getString(R.string.layout_direction);
                        if(layoutDirection.equals("0")){
                            ...
                            //if (arrowHintContainer.getX() + arrowHintContainer.getWidth() > getWidth() * swipeDistance) {
                            if (arrowHintContainer.getX() - arrowHintContainer.getWidth() < 0) {
                                // swipe completed, fly the hint away!
                                performSuccessfulSwipe();
