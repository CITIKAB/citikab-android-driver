package com.trioangle.goferdriver.earning;
/**
 * @package com.trioangle.goferdriver.earning
 * @subpackage earning
 * @category BarView
...
import com.trioangle.goferdriver.helper.MyUtils;
...
public class BarView extends View {
    ...
    private final int FOREGROUND_COLOR = Color.parseColor("#32A62F");
    ...
    public BarView(Context context, AttributeSet attrs) {
       ...
       /* bgPaint = new Paint();
        ...
        BAR_SIDE_MARGIN = MyUtils.dip2px(context, 20);
