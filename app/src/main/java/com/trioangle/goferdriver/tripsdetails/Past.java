...
*************************************************************** */
public class Past extends Fragment implements ServiceListener, RecyclerView.OnItemTouchListener {
    ...
    @InjectView(R.id.past_recycler_view)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if ("1".equals(laydir)) {
            ...
            emptylist.setRotationY(180);
        }
        countries = new ArrayList<PastTripModel>();
        YourTrips activity = (YourTrips) getActivity();
        countries = activity.getPastTripDetailsList();
        ...
        TripsAdapter adapter = new TripsAdapter(countries, getContext());
    ...
    private void onSuccessRiderProfile(JsonResponse jsonResp) {
        ...
        sessionManager.setBookingType(earningModel.getBookingType());
...
/*
    ...
    public void onTouchEvent(RecyclerView rv, MotionEvent e) {
        CommonMethods.DebuggableLogI("onTouchEvent", "onTouchEvent");
    }

    @Override
    public void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept) {
        CommonMethods.DebuggableLogI("onTouchEvent", String.valueOf(disallowIntercept));
